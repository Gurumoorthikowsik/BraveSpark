        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="{{URL::to('employees/dashboard')}}">
                    <b class="logo-abbr"><img src="{{site_setting()->site_fav}}" alt=""> </b>
                    <span class="logo-compact"><img src="{{ asset('employee/images/logo-compact.png')}}" alt=""></span>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{URL::to('viewall-template')}}" aria-expanded="true">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Templates</span>
                        </a>
                    </li>
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-notebook menu-icon"></i><span class="nav-text">Task Management</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ URL::to('taskassign') }}">Task Template</a></li>

                            <li><a href="{{ URL::to('myprojects') }}">My Projects</a></li>

                            @if (Dev_access(Session::get('empuser_id')))
